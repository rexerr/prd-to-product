...
2. **Update the docs the work changed.** Tick completed checkboxes in `ROADMAP.md` (mark a phase done only when its "done-when" is met). Log any significant decision in `docs/DECISIONS.md`. Check off resolved items in `docs/PARKING_LOT.md`.
