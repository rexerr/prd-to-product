...
- **No temporal, provenance, or source-attribution claims about source material.** When summarizing a brief or notes, describe what the material contains: (a) never speculate about *when* it was written or how stale it might be ("written a while ago," "your thinking may have sharpened since") — cite a date only if the material itself states one; (b) never **attribute a claim to a source the material doesn't name** — do not write "based on your research," "as your user interviews show," or "per the strategy deck" unless that research / those interviews / that deck are actually present in the material. **Failure it prevents:** a confident but ungrounded claim — about *when* the material was made ("the brief is from days ago") or about *where a fact came from* ("based on your research" when no research was given) — is often wrong and undermines trust in everything else the skill asserts.
