...
| [/mine](tickets/mine.md) | next | 2 | Settle form fork (playbook vs explicit-invoke skill); build engine + wire lens A — via `/furnace-plan` | [D-022](docs/DECISIONS.md#d-022) |
...
| [Docs structure & artifact routing](tickets/docs-routing.md) | next | 6 | Build routing rule + intake Q + `docs/README.md` map (research done; create-the-few not all-empty) | [brief](docs/briefs/docs-structure-and-artifact-routing-brief.md) |
