...
|---|---|---|---|---|---|---|
| [Fix recurring lens bug — state the telos in CLAUDE.md/AGENTS.md](docs/handoffs/project-setup-system-handoff.md) | chore | next | 1 | area:docs | Add a top-of-file "what this is FOR" north-star + relevance test so sessions stop collapsing the work to tidying skill `.md` instead of improving downstream projects (observed 3× 2026-06-30); gated on Rex, land before the repo eval. | [handoff §0](docs/handoffs/project-setup-system-handoff.md) |
| [Project-setup system — review & design](docs/handoffs/project-setup-system-handoff.md) | research | next | 2 | area:skill | The trio is necessary-not-sufficient: map the full idea→set-up-right→built→secure/tested path; next session reviews real projects + TanStack template/workflow/devtools + online research, then decides compose-vs-build. | [handoff](docs/handoffs/project-setup-system-handoff.md) |
