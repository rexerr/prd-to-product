...
| Supply-chain + dep-automation scaffold defaults | feature | backlog | — | area:build-defaults | Scaffold recommends the bounded security/maintenance set a mature foundation actually uses: `renovate.json` (minor-automerge, majors gated), `provenance=true`, install-script allowlist, SHA-pinned CI actions — no vuln/secret scan needed. | [mine](docs/mined/2026-07-01-tanstack-template.md) |
