...
|---|---|---|---|---|
| [Furnace blind-review hardening](tickets/furnace-blind-review-hardening.md) | next | 1 | Fixed reviewer-prompt template + pinned model — author improvisation tainted the blind review twice (2026-06-24); `/furnace-plan` the SKILL.md self-edit | [retro](docs/retros/2026-06-24-no-jargon-leak-scan.md) |
