...
| /mine compound-engineering-plugin | research | next | 2 | area:skill-templates | Targeted mine of Every's plugin repo (clone on disk, SHA db21ba2): its AGENTS.md authoring guide + docs/solutions/skill-design/ + 2-3 large skills — the deletion test, inline-the-trigger, and a token-cost-shaped size rule validate or challenge our house rules with documented failure evidence. | [mine](docs/mined/2026-07-01-every-agent-native-guides.md) |
