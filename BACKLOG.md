...
| Rough-render-before-the-gauntlet (scaffold trait) | chore | backlog | — | area:scaffold | Scaffold emits "show a cheap rough render before any heavy review (furnace/Cowork/council/build)" as a project trait — Rex wants every project to do this, not just here. | [retro](docs/retros/2026-06-26-kanban-schema-and-render-redesign.md) |
