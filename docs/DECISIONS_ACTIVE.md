<!-- Reconciled against DECISIONS.md through D-035 · 2026-06-18. If DECISIONS.md carries higher-numbered decisions not yet evaluated for this view, this marker is stale — re-reconcile and bump it. Curated subset, NOT a completeness claim: not every D-NNN ≤ D-035 appears here (many are deliberately skipped as visible-by-reading; D-031/D-032/D-033/D-035 evaluated, not mirrored — visible by reading the furnace-plan/prd-creator/CLAUDE.md files; D-034 mirrored below). Bump this line whenever a new decision is evaluated for mirroring, mirrored or not. -->
