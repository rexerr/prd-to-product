<!-- Reconciled against DECISIONS.md through D-029 · 2026-06-18. If DECISIONS.md carries higher-numbered decisions not yet evaluated for this view, this marker is stale — re-reconcile and bump it. Curated subset, NOT a completeness claim: not every D-NNN ≤ D-029 appears here (many are deliberately skipped as visible-by-reading). Bump this line whenever a new decision is evaluated for mirroring, mirrored or not. -->
