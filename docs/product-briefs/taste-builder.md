...
- **Naming.** Working name "Taste Builder" is loaded. Current shortlist: **Taste Journal** (modest, reflective, sketchbook-coded), **Throughline** (names what the product surfaces, no aesthetic baggage), **Taste Refinery** (process metaphor — raw saves → refined judgment). Backup options: Point of View, Pattern Library, Aesthetic Memory, Atelier, Squint, Reps. Defer the final call but capture for the PRD.
