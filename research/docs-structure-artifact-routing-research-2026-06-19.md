...
4. **Crib/mine-workflow alignment** — does the `/repo-miner` staging convention (`mines/<date>-<source>/`, per BACKLOG) want to be the same mechanism as artifact landing zones, or a separate one?
