...
resolved: 2026-06-22 — rehost shipped (D-042/D-043, deployed 06-19); cc-subagent→Cowork-transcribe loop proven live + paired (ledger: 06-20 G-14/context-lifecycle, 06-22 /mine). Residuals: skill evals (conditional) + the promote/kill paired-data wrinkle (lives in the paused furnace-trial item).
---
